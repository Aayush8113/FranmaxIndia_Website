...
const LazySellBusinessPage = lazy(() =>
  import("./components/Business/SellBusinessPage")
);
...
const LazyLeasePropertyForm = lazy(() =>
  import("./components/Property/LeasePropertyPage")
);
...
const LazyBuyPropertyInquiries = lazy(() =>
  import("./admin/BuyPropertyInquiries")
);
const LazyRealEstateServices = lazy(() =>
  import("./components/RealEstateServices")
);
const LazyFranchiseDevelopment = lazy(() =>
  import("./components/FranchiseDevelopment")
);
const ConsultingPage = lazy(() => import("./components/ConsultingPage"));
const FranchisePage = lazy(() => import("./components/FranchisePage"));
const LazyFranchiseListing = lazy(() =>
  import("./components/FranchiseListing")
);
...
const LazySellBusinessInquiries = lazy(() =>
  import("./admin/SellBusinessInquiries")
);
...
const LazyInvestorDashboardPage = lazy(() =>
  import("./investor/DashboardPage")
);
...
function AppContent() {
  ...
  const hideLayoutRoutes = [
    ...
    "/brand/upload-docs",
    "/admin/login",
    "/admin/marketing-inquiries",
    "/admin/dashboard",
    "/admin/buy-business-inquiries",
    "/admin/add-investor",
    "/admin/investors",
    "/admin/leads",
    ...
    "/user-list",
    "/denied",
    "/admin/sell-business-inquiries",
    "/admin/lease-properties",
    ...
    <>
      ...
      <Routes>
        ...
        <Route
          ...
          element={
            <Suspense fallback={FallbackSpinner}>
              <LazyLeasePropertyForm />
            </Suspense>
          }
        />
        <Route
          path="/all-lease-properties"
          element={
            <Suspense fallback={FallbackSpinner}>
              <LazyPropertyList />
            </Suspense>
        ...
        />
        <Route
          path="/franchises/category/:categoryId"
          element={
            <Suspense fallback={FallbackSpinner}>
              <LazyFranchiseListing />
            </Suspense>
          }
        />
        <Route
...
/> */}
        ...
        <Route
          ...
          element={
            <ProtectedRoute
              requiredPermissions={["view_buy_business_inquiries"]}
            >
              <Suspense fallback={FallbackSpinner}>
                <LazyBuyPropertyInquiries />
              </Suspense>
            </ProtectedRoute>
          }
        />
        ...
        <Route
          ...
          element={
            <ProtectedRoute
              requiredPermissions={["view_sell_business_inquiries"]}
            >
              <Suspense fallback={FallbackSpinner}>
                <LazySellBusinessInquiries />
              </Suspense>
            </ProtectedRoute>
          }
        />
        ...
        <Route
          ...
          element={
            <Suspense faallback={FallbackSpinner}>
              <LazyBrandDashboard />
            </Suspense>
          }
        />
        <Route
          path="/brand/inquiries"
          element={
            <Suspense fallback={FallbackSpinner}>
              <LazyBrandInquiries />
            </Suspense>
        ...
        />
        <Route
          path="/investor-brands"
          element={
            <Suspense fallback={FallbackSpinner}>
              <LazyInvestorBrandListing />
            </Suspense>
          }
        />
