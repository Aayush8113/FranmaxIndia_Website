...
const LazyInhouseBrand=lazy(()=>import("./admin/InhouseBrand"));
const LazyInhouseBrandDisplay=lazy(()=>import("./admin/DisplayinhouseBrands"));
const LazyInhouseInvestor=lazy(()=>import("./admin/InhouseInvestor"));
const LazyInhouseInvestorDisplay=lazy(()=>import("./admin/DisplayinhouseInvestor"));
...
function AppContent() {
  ...
  const hideLayoutRoutes = [
    ...
    '/investor-dashboard',"/admin/event","/investor-profile","/investor-pricing","/investor-brands","/admin/inhouse-brand","/admin/inhouse-brands-display","/admin/inhouse-investor-display","/admin/inhouse-investors-display","/admin/inhouse-investor"
  ];
...
/> */}
        ...
        />
         <Route
          path="/admin/inhouse-brand"
          element={
            <ProtectedRoute requiredPermissions={['add_inhouse_brand']}>
              <Suspense fallback={FallbackSpinner}><LazyInhouseBrand /></Suspense>
            </ProtectedRoute>
          }
        />
         <Route
          path="/admin/inhouse-investor"
          element={
            <ProtectedRoute requiredPermissions={['add_inhouse_investor']}>
              <Suspense fallback={FallbackSpinner}><LazyInhouseInvestor /></Suspense>
            </ProtectedRoute>
          }
        />
          <Route
          path="/admin/inhouse-brands-display"
          element={
            <ProtectedRoute requiredPermissions={['view_inhouse_brand']}>
              <Suspense fallback={FallbackSpinner}><LazyInhouseBrandDisplay /></Suspense>
            </ProtectedRoute>
          }
        />
         <Route
          path="/admin/inhouse-investor-display"
          element={
            <ProtectedRoute requiredPermissions={['view_inhouse_investor']}>
              <Suspense fallback={FallbackSpinner}><LazyInhouseInvestorDisplay /></Suspense>
            </ProtectedRoute>
          }
        />
        <Route
